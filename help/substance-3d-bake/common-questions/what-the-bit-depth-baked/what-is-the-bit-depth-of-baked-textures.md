...
breadcrumb-title: ''
description: ベイクしたテクスチャのビット深度と、それがテクスチャの画質とファイルサイズにどのように影響するかを理解します。
...
> 
> ベイカー出力は16ビットRGBAテクスチャとして生成されます。 最終的なビット深度は、テクスチャの保存に使用するターゲットファイルフォーマットによって異なります。 32bitsファイル形式では、16bitsの入力情報は変換されますが、それ以上の精度は得られません。
