...
breadcrumb-title: ''
description: Automation Toolkitで利用可能なSubstance ベイカーのコマンドラインバージョンであるsbsbakerの使用方法を説明します。
...
詳しくは、[専用ドキュメント &#x200B;](https://helpx.adobe.com/jp/substance-3d-sat/command-line-tools/sbsbaker.html)を参照してください。
