...
ベイクウィンドウには、[エクスプローラー](https://helpx.adobe.com/jp/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html)ウィンドウのメッシュファイルからアクセスできます。 メッシュ名を右クリックして「**モデル情報を烘焙**」を選択し、ベイクウィンドウを開きます。
...
ベイカーでは、作成するベイクテクスチャを選択できます。 デフォルトでは、リストは空です。
...
* ベイカーを下へ移動：**リストでベイカーを選択し、「下へ移動」ボタンをクリックします。
