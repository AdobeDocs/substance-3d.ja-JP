...
一部のベイカーは、GPU上のレイトレーシングのハードウェアアクセラレーションをサポートしています。これにより、通常は計算の速度が25倍以上に速くなります。

## ハードウェア要件

レイトレーシングは、次の要件に従っている場合に自動的に有効になります。
...
次の表に、Substance 3D ベイカーのバージョンに従って、各ベイカーでサポートされているGPU レイトレーシングを示します。
...
\*: CPU GPU レイトレーシングをサポートします。このレイトレーシングは、データよりも非常に低速です。
