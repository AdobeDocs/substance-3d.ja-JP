...
breadcrumb-title: ''
description: 公開したアートワークやクリエイティブプロジェクトで使用する、様々な形式の公式Substance 3Dアプリケーションアイコンをダウンロードします。
helpx_creative_field: ''
helpx_description: General Knowledge > Ecosystem > Substance 3D icons for artists
helpx_experience_level: ''
helpx_learn_topic: ''
helpx_tags: ''
title: アーティストのSubstance 3Dアイコン
...
[Substance 3Dアイコン](https://shared-assets.adobe.com/link/4c83a12c-3948-4151-5be1-ad75f4a64be0)

## 例

![Substance 3Dアイコンの統合例](../../assets/3d-icons-artworks.png)
