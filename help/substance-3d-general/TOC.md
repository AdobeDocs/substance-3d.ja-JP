---
user-guide-description: Substance 3Dの一般的な知識
user-guide-title: Substance 3Dの一般的な知識
breadcrumb-title: Substance 3Dの一般的な知識
...
# Substance 3Dの一般的な知識 {#general-knowledge}

+ [ホーム](/help/substance-3d-general/home/home.md)
+ [ドキュメント移行に関するFAQ](/help/substance-3d-general/migration-faq/migration-faq.md)
+ エコシステム{#ecosystem}
  + [エコシステムの概要](/help/substance-3d-general/ecosystem/ecosystem.md)
  + [一般的な必要システム構成](/help/substance-3d-general/ecosystem/system-requirements/general-system-requirements.md)
  + Substance 3D Linux版{#substance-3d-for-linux}
    + [ADAを使用してLinuxライセンスを管理](/help/substance-3d-general/ecosystem/for-linux/substance-for-linux.md)
