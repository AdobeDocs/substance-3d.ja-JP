...
# 3ds MaxのSubstanceテクスチャ

3ds MaxプラグインのSubstanceは、出力のガンマ設定を処理します。

テクスチャを読み込む場合、メタリック、ラフネス、法線、Height、ディスプレイスメントなど、色以外のデータを表すイメージのガンマをOverride1.0に設定する必要があります。
