---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-integrations/game-engines/unity/unity-release-notes/unity-2-6-0.html"
breadcrumb-title: ''
...
* HDRPプロジェクトでは、ディスプレイスメント設定を変更すると、マテリアルモードがデフォルト値(Tessallation)に戻ります
...
* Substanceプラグインがインストールされている場合、画像ファイルのテクスチャプレビューはインスペクターに表示されません
