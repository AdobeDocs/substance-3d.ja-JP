---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-integrations/game-engines/unity/scripting-in-unity-deprecated/scripting-api.html"
breadcrumb-title: ''
...
## Substanceマテリアルパラメーター

| Publicメソッド | 説明 | パラメーター |
| --- | --- | --- |
| パブリック&#x200B;**float** *GetInputFloat*（**文字列** inputName） | Substance **Float**&#x200B;の入力を取得 | **文字列** *inputName* SBSARの入力の名前 |
| パブリック&#x200B;**int** *SetInputFloat*（**文字列**&#x200B;入力名、**浮動小数点**&#x200B;値） | Substance **Float**&#x200B;入力の更新 | **文字列** i *nputName* SBSARの入力の名前&#x200B;**浮動小数点** *値*&#x200B;パラメーターの更新に使用される値 |
...
| パブリック&#x200B;**void** *SetInputBool*（**文字列** inputName、**bool**&#x200B;値） | Substance **ブール値**&#x200B;の入力を更新します | **文字列** *inputName* SBSARの入力の名前&#x200B;**Bool** *値*&#x200B;パラメーターの更新に使用される値 |
| パブリック&#x200B;**bool** *GetInputBool*（**文字列** inputName） | Substance **ブール値**&#x200B;の入力を取得します | **文字列** *inputName* SBSARの入力の名前 |
...
エディターモードでグラフの変更を永続的にするには、対応する各Substanceを再インポートする必要があります。 これは、次の関数で実行されます。
