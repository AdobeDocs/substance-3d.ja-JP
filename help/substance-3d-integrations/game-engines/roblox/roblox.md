...
* [新しいSubstance グラフ](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/create-a-graph-102400068.html)ウィンドウで、`Roblox`テンプレートを選択します
* グラフの識別子とその他のパラメーターを設定し、[**OK**]をクリックします
* [ワークフロー](https://experienceleague.adobe.com/en/docs/substance-3d-designer/using/workspace/graph-view/the-graph-view)でマテリアルを操作します。グラフビューの使用を開始するには、[ここ](https://experienceleague.adobe.com/en/docs/substance-3d-designer/using/getting-started/workflow-overview)を参照してください
...
Robloxシーンで新しいマテリアルバリエーションを使用する
