...
breadcrumb-title: ''
description: Blueprintsを使って、Unreal エンジン 4の実行時にSubstanceマテリアルから動的なマテリアルインスタンスを作成します。
...
1. Createグラフインスタンスノードの戻り値を使用して、動的なSubstanceマテリアルの変数を設定します。
1. マテリアルタイプの変数を作成します。 これがマテリアルテンプレートになります。 コンテンツブラウザで、Substanceによって生成されたUE4マテリアルの複製を作成します。 複製されたこのマテリアルを、マテリアルテンプレート変数の入力として設定します。
...
1. MID Name変数を、手順5で指定した複製マテリアルのチャンネル名に設定します。 *マテリアルイメージを表示します。*
