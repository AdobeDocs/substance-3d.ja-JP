...
1. **マテリアル**&#x200B;型および&#x200B;**マテリアルインスタンスダイナミック**&#x200B;型の変数を作成します
1. **Substance接続を確立**&#x200B;し、出力と入力の識別子を設定します。
1. **集約Substanceインスタンスファクトリ**&#x200B;を作成し、出力ファクトリと入力ファクトリを設定します。
1. **グラフインスタンス**&#x200B;を作成し、インスタンス名を設定します。
1. **集計グラフインスタンス**&#x200B;変数を設定します。
1. **[テクスチャの取得]**&#x200B;を使用して、手順7の集計グラフインスタンスからSubstance Substanceを取得します。
1. 手順3のマテリアル変数を親として使用して、**動的マテリアルインスタンス**&#x200B;を作成します。
1. 手順3で定義したMID変数を設定します。
1. MID変数を使用して&#x200B;**マテリアルを設定**&#x200B;して、メッシュのマテリアルを設定します。
