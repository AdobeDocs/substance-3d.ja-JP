...
breadcrumb-title: ''
description: Unreal Engine 4のBlueprintノードを使用すると、動的マテリアルワークフローの実行時にSubstanceマテリアルを制御できます。
...
このセクションでは、Unreal EngineでSubstanceマテリアルと[青写真](https://docs.unrealengine.com/en-US/Engine/Blueprints/GettingStarted/index.html)を使用する方法について説明します。

## 目次

* [Blueprint(UE4):Substanceのマテリアルパラメーター](https://helpx.adobe.com/jp/substance-3d/unlisted/documentation/integrations/blueprint-substance-material-parameters-151584792.html)
