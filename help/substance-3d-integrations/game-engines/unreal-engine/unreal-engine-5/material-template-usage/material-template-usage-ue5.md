---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-integrations/game-engines/unreal-engine/unreal-engine-5/material-template-usage-ue5.html"
breadcrumb-title: ''
description: Unreal Engine 5でマテリアルテンプレートを作成し、使用して、Substance出力ノードをマテリアル入力に接続する方法を定義します。
helpx_creative_field: ""
helpx_description: Ecosystems and Plugins > Game Engines > Unreal Engine > Unreal Engine 5 > Material Template Usage - UE5
helpx_experience_level: ""
helpx_learn_topic: ""
helpx_tags: ""
title: マテリアルテンプレートの使用 – UE5
...
マテリアルテンプレートを使用すると、マテリアルの入力に出力ノードを接続するためのテンプレートとして使用するマテリアルのベースマテリアルを作成できます。\
マテリアル入力と同じ名前とタイプを共有する出力が自動的に使用されます。 このParent Materialのサンプルには「baseColor」テクスチャサンプルノードがあります。このノードは、Substanceに「baseColor」という名前のテクスチャ出力がある場合に埋め込まれます。\
...
Substance Graphインスタンスは、作成時に関連するすべての出力値の入力を試みます。
