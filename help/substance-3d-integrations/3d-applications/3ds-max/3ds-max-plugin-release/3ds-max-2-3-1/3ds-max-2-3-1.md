---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-integrations/3d-applications/3ds-max/3ds-max-plugin-release-notes/3ds-max-2-3-1.html"
breadcrumb-title: ''
...
* 最大バッチの問題を削除するには、スレート材料エディターを無効にしてドラッグ&amp;ドロップしてください
...
* Substance 2のSubstanceFilePathに空のパスが割り当てられているときに、Maxがクラッシュしなくなりました
...
* シーンを開いたときにパラメトリックブロックIDが強制的にクリアされるようになり、シーンファイル間の衝突が削除されました。 これにより、シーン間で交互に読み込まれる場合の無効なパラメータブロックの問題が修正されます。 より複雑な変更が必要となるため、読み込みにはまだ問題がある場合があります
