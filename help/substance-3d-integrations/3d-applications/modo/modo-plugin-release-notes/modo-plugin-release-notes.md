...
breadcrumb-title: ''
description: 新機能や修正点を常に最新の状態に保つには、MODO用Substanceプラグインのすべてのバージョンのリリースノートを確認してください。
helpx_creative_field: ""
helpx_description: Ecosystems and Plugins > 3D Applications > MODO > Modo Plugin Release Notes
helpx_experience_level: ""
helpx_learn_topic: ""
helpx_tags: ""
title: Modoプラグインのリリースノート
...
* [モードv. 2.7.5](../../../3d-applications/modo/modo-plugin-release-notes/modo-v-2-7-5/modo-v-2-7-5.md)
* [モードv. 2.7.4](../../../3d-applications/modo/modo-plugin-release-notes/modo-v-2-7-4/modo-v-2-7-4.md)
