---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-integrations/3d-applications/maya/maya-plugin-release-notes/maya-3-0-0-plus.html"
breadcrumb-title: ''
...
* MayaのSubstanceプラグインのロード/アンロードでエラー画面が表示されてクラッシュする問題を解決しました。
* キャッシュの問題を修正しました。特に.exrファイルが正しく参照されるようにし、大きなシーンでのキャッシュ関連のフリーズを減らしました。
* SBSARファイルをMayaプラグインにロードすると、サンプルウィンドウのマテリアルプレビューが表示されない問題を解決しました。
* 少なくとも1つのSBSARが既にハイパーシェードにある場合、コネクタがSBSARファイルを受信できない問題を解決しました。
